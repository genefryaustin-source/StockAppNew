...
class Portfolio(Base):
    ...
    # Which user within the tenant owns this portfolio -- nullable
    # since existing portfolios created before this column existed
    # have no owner recorded. String, matching modules.db.models.User.
    # id / AuthenticatedUser.user_id (the real, current user-id
    # convention throughout this API) -- not TradeOrder.user_id's
    # older Integer convention below, which is a separate,
    # already-known mismatch.
