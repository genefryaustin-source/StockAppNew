...
def _render_positions(db, tenant_id: str, user_id: str, paper: bool):
    ...
    if cache_key not in st.session_state:
        with st.spinner("Loading positions…"):
            broker = AlpacaOptionsBroker(paper=paper)
            live_positions = broker.list_options_positions()
            st.session_state[cache_key] = live_positions

            from modules.options.options_models import upsert_positions
            upsert_positions(db, tenant_id, user_id, live_positions)
