...
from modules.admin.external_api_keys_ui import (
    render_external_api_keys_tab,
)
...
def render_admin_panel(db, user):
    ...
    # =========================================================
    with external_api_keys_tab:

        render_external_api_keys_tab(db, user)
