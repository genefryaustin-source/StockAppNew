...
class ForexHistoryRepository:
    def __init__(
        ...
        *,
        ...
        # Same bug pattern found (and fixed) elsewhere in this module:
        # ensure_tables() is correctly written and safe to call
        # unconditionally (no-ops if db is None, module-level guard
        # against redundant CREATE TABLE calls), but was never actually
        # invoked anywhere. Confirmed directly: forex_factor_models_
        # dashboard.py crashed with "no such table: forex_price_history"
        # on a fresh database.
        self.ensure_tables()
